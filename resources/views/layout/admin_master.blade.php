...
<head>
	...
	<title>Movies Recommendy - Administrator</title>
...
<body>
	...
	<header class="header">
		<div class="header__content">
			<!-- header logo -->
			<a href="{{route('admin')}}" class="header__logo">
				<img src="{{asset('assets')}}/admin/img/movie-svgrepo-com.svg" alt="">
			</a>
			<!-- end header logo -->
	...
	<div class="sidebar">
		...
		<a href="index.html" class="sidebar__logo">
			<img src="{{asset('assets')}}/admin/img/play-svgrepo-com.svg" alt="" style="max-height: 60px">
			<b>Movies Recommendy</b>
		</a>
		<!-- end sidebar logo -->
		...
		<div class="sidebar__user">
			<div class="sidebar__user-img">
				<img src="{{asset('assets')}}/admin/img/user.svg" alt="" style="max-height: 50px">
			</div>
		...
		<ul class="sidebar__nav">
			<li class="sidebar__nav-item">
				<a href="{{route('admin')}}" class="sidebar__nav-link sidebar__nav-link--active"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M10,13H3a1,1,0,0,0-1,1v7a1,1,0,0,0,1,1h7a1,1,0,0,0,1-1V14A1,1,0,0,0,10,13ZM9,20H4V15H9ZM21,2H14a1,1,0,0,0-1,1v7a1,1,0,0,0,1,1h7a1,1,0,0,0,1-1V3A1,1,0,0,0,21,2ZM20,9H15V4h5Zm1,4H14a1,1,0,0,0-1,1v7a1,1,0,0,0,1,1h7a1,1,0,0,0,1-1V14A1,1,0,0,0,21,13Zm-1,7H15V15h5ZM10,2H3A1,1,0,0,0,2,3v7a1,1,0,0,0,1,1h7a1,1,0,0,0,1-1V3A1,1,0,0,0,10,2ZM9,9H4V4H9Z"/></svg> Dashboard</a>
			</li>

			<li class="sidebar__nav-item">
				<a href="{{route('genres')}}" class="sidebar__nav-link"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M21,2a1,1,0,0,0-1,1V5H18V3a1,1,0,0,0-2,0V4H8V3A1,1,0,0,0,6,3V5H4V3A1,1,0,0,0,2,3V21a1,1,0,0,0,2,0V19H6v2a1,1,0,0,0,2,0V20h8v1a1,1,0,0,0,2,0V19h2v2a1,1,0,0,0,2,0V3A1,1,0,0,0,21,2ZM6,17H4V15H6Zm0-4H4V11H6ZM6,9H4V7H6Zm10,9H8V13h8Zm0-7H8V6h8Zm4,6H18V15h2Zm0-4H18V11h2Zm0-4H18V7h2Z"/></svg> Genres</a>
			</li>
	...
	<script src="{{asset('assets')}}/admin/js/slimselect.min.js"></script>
	<script src="{{asset('assets')}}/admin/js/admin.js"></script>
</body>

<!-- Mirrored from flixgo.volkovdesign.com/admin/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 03 Feb 2025 09:12:29 GMT -->
</html>