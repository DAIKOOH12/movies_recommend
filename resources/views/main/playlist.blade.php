...
<!-- Mirrored from templates.iqonic.design/streamit-dist/frontend/html/playlist.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 04 Feb 2025 04:13:13 GMT -->
...
<body class=" custom-header-relative ">
    ...
    <div class="loader simple-loader">
        <div class="loader-body">
            <img src="{{asset('assets')}}/main/img/loader.gif" alt="loader" class="img-fluid " width="300">
        </div>
    </div>
    <!-- loader END -->
            ...
            <div class="footer-top">
                <div class="row">
                    <div class="col-xl-3 col-lg-6 mb-5 mb-lg-0">
                        ...
                        <p class="mb-4 font-size-14">Email us: <span class="text-white">customer@mvr.com</span>
                        </p>
            ...
            <div class="footer-bottom border-top">
                <div class="row align-items-center">
                    <div class="col-md-6">
                        ...
                        <p class="font-size-14">© <span class="currentYear"></span> <span class="text-primary">Movie Recommedy</span>. All Rights Reserved. All videos and shows on this platform are trademarks of, and all related images and content are the property of, Movie Recommedy Inc. Duplication and copy of this is strictly prohibited.</p>
                    </div>
                    <div class="col-md-3"></div>
                    <div class="col-md-3">
                        <h6 class="font-size-14 pb-1">Download Movie Recommedy Apps </h6>
...
<!-- Mirrored from templates.iqonic.design/streamit-dist/frontend/html/playlist.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 04 Feb 2025 04:13:16 GMT -->
