...
<!-- Mirrored from templates.iqonic.design/streamit-dist/frontend/html/error-page-one.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 04 Feb 2025 04:13:18 GMT -->
...
<head>
	...
	<!-- Favicon -->
	<link rel="shortcut icon" href="{{asset('assets')}}/main/img/favicon.ico" />
		...
		<div class="section-padding vh-100">
			<div class="container h-100">
				<div class="row h-100 align-items-center">
					...
					<div class="col-lg-8">
						<img src="{{asset('assets')}}/main/img/pages/404.html" alt="404" loading="lazy">
						<div class="py-3 text-center mt-5 mb-4" style="background-repeat: no-repeat; background-position: center center; background-size: 68% auto;">
							<h4 class="fw-semibold mb-0">Oops! something went wrong</h4>
						</div>
						<p class="text-center">We’re sorry, it looks like the page you’re looking for isn’t in our system</p>
