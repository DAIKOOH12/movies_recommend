                    ...
                    <div class="row">
                        <div class="col-md-9 col-12 mb-auto">
                            ...
                            <ul class="p-0 mt-2 list-inline d-flex flex-wrap movie-tag">
                                <li class="trending-list"><a class="text-primary" href="{{route('allmovies')}}">Action</a></li>
                                <li class="trending-list"><a class="text-primary" href="{{route('allmovies')}}">Adventure</a></li>
                                <li class="trending-list"><a class="text-primary" href="{{route('allmovies')}}">Drama</a></li>
                            </ul>
                            ...
                            <ul class="iq-blogtag list-unstyled d-flex flex-wrap align-items-center gap-3 p-0">
                                ...
                                <li><a class="title" href="{{route('allmovies')}}">Action</a><span class="text-secondary">,</span></li>
                                <li><a class="title" href="{{route('allmovies')}}">Adventure</a><span class="text-secondary">,</span></li>
                                <li><a class="title" href="{{route('allmovies')}}">Drama</a><span class="text-secondary">,</span></li>
                            </ul>
                        </div>
                        <div class="trailor-video col-md-3 col-12 mt-lg-0 mt-4 mb-md-0 mb-1 text-lg-right">
                            <a data-fslightbox="html5-video" href="https://www.youtube.com/watch?v=QCGq1epI9pQ"
                                ...
                                <img src="{{asset('assets')}}/main/img/genre/01.html" class="attachment-medium-large size-medium-large wp-post-image"
                                    alt="" loading="lazy" />
                    ...
                    <div class="position-relative swiper swiper-card" data-slide="5" data-laptop="5" data-tab="3" data-mobile="2"
                        ...
                        <ul class="list-inline swiper-wrapper">
                            <li class="swiper-slide">
                                <div class="cast-images m-0 row align-items-center position-relative">
                                    <div class="col-4 img-box p-0">
                                        <img src="{{asset('assets')}}/main/img/genre/g1.html" class="img-fluid" alt="image" loading="lazy">
                                    </div>
                            ...
                            <li class="swiper-slide">
                                <div class="cast-images m-0 row align-items-center position-relative">
                                    <div class="col-4 img-box p-0">
                                        <img src="{{asset('assets')}}/main/img/genre/g2.html" class="img-fluid" alt="image" loading="lazy">
                                    </div>
                                    <div class="col-8 block-description">
                                        <h6 class="iq-title">
                    ...
                    <div class="position-relative swiper swiper-card" data-slide="5" data-laptop="5" data-tab="3" data-mobile="2"
                        ...
                        <ul class="list-inline swiper-wrapper">
                            <li class="swiper-slide">
                                <div class="cast-images m-0 row align-items-center position-relative">
                                    <div class="col-4 img-box p-0">
                                        <img src="{{asset('assets')}}/main/img/genre/g3.html" class="img-fluid" alt="image" loading="lazy">
                                    </div>
                            ...
                            <li class="swiper-slide">
                                <div class="cast-images m-0 row align-items-center position-relative">
                                    <div class="col-4 img-box p-0">
                                        <img src="{{asset('assets')}}/main/img/genre/g5.html" class="person__poster--image img-fluid" alt="image"
                                            loading="lazy">
                                    </div>
                                    <div class="col-8 block-description starring-desc ">
                                        <h6 class="iq-title">
                            ...
                            <li class="swiper-slide">
                                <div class="cast-images m-0 row align-items-center position-relative">
                                    <div class="col-4 img-box p-0">
                                        <img src="{{asset('assets')}}/main/img/genre/g4.html" class="person__poster--image img-fluid" alt="image"
                                            loading="lazy">
                                    </div>
                                    <div class="col-8 block-description starring-desc ">
                                        <h6 class="iq-title">
                        ...
                        <li class="swiper-slide">
                            <div class="iq-card card-hover">
                                <div class="block-images position-relative w-100">
                                    <div class="img-box w-100">
                                        <a href="{{route('details')}}" class="position-absolute top-0 bottom-0 start-0 end-0"></a>
                                        <img src="{{asset('assets')}}/main/img/movies/upcoming/01.html" alt="movie-card" class="img-fluid object-cover w-100 d-block border-0">
                                    </div>
                                    <div class="card-description with-transition">
                                        <div class="cart-content">
                                            <div class="content-left">
                                                <h5 class="iq-title text-capitalize">
                                                    <a href="{{route('details')}}">dinoosaur</a>
                                                </h5>
                                                <div class="movie-time d-flex align-items-center my-2">
                                                    <span class="movie-time-text font-normal">2hr : 12mins</span>
                                                </div>
                        ...
                        <li class="swiper-slide">
                            <div class="iq-card card-hover">
                                <div class="block-images position-relative w-100">
                                    <div class="img-box w-100">
                                        <a href="{{route('details')}}" class="position-absolute top-0 bottom-0 start-0 end-0"></a>
                                        <img src="{{asset('assets')}}/main/img/movies/upcoming/02.html" alt="movie-card" class="img-fluid object-cover w-100 d-block border-0">
                                    </div>
                                    <div class="card-description with-transition">
                                        <div class="cart-content">
                                            <div class="content-left">
                                                <h5 class="iq-title text-capitalize">
                                                    <a href="{{route('details')}}">godilla</a>
                                                </h5>
                                                <div class="movie-time d-flex align-items-center my-2">
                        ...
                        <li class="swiper-slide">
                            <div class="iq-card card-hover">
                                <div class="block-images position-relative w-100">
                                    <div class="img-box w-100">
                                        <a href="{{route('details')}}" class="position-absolute top-0 bottom-0 start-0 end-0"></a>
                                        <img src="{{asset('assets')}}/main/img/movies/upcoming/03.html" alt="movie-card" class="img-fluid object-cover w-100 d-block border-0">
                                    </div>
                                    <div class="card-description with-transition">
                                        <div class="cart-content">
                                            <div class="content-left">
                                                <h5 class="iq-title text-capitalize">
                                                    <a href="{{route('details')}}">batter caill</a>
                                                </h5>
                                                <div class="movie-time d-flex align-items-center my-2">
                        ...
                        <li class="swiper-slide">
                            <div class="iq-card card-hover">
                                <div class="block-images position-relative w-100">
                                    <div class="img-box w-100">
                                        <a href="{{route('details')}}" class="position-absolute top-0 bottom-0 start-0 end-0"></a>
                                        <img src="{{asset('assets')}}/main/img/movies/upcoming/04.html" alt="movie-card" class="img-fluid object-cover w-100 d-block border-0">
                                    </div>
                                    <div class="card-description with-transition">
                                        <div class="cart-content">
                                            <div class="content-left">
                                                <h5 class="iq-title text-capitalize">
                                                    <a href="{{route('details')}}">the co nouerllng</a>
                                                </h5>
                                                <div class="movie-time d-flex align-items-center my-2">
                                                    <span class="movie-time-text font-normal">1hr : 30mins</span>
                                                </div>
                        ...
                        <li class="swiper-slide">
                            <div class="iq-card card-hover">
                                <div class="block-images position-relative w-100">
                                    <div class="img-box w-100">
                                        <a href="{{route('details')}}" class="position-absolute top-0 bottom-0 start-0 end-0"></a>
                                        <img src="{{asset('assets')}}/main/img/movies/upcoming/05.html" alt="movie-card" class="img-fluid object-cover w-100 d-block border-0">
                                    </div>
                                    <div class="card-description with-transition">
                                        <div class="cart-content">
                                            <div class="content-left">
                                                <h5 class="iq-title text-capitalize">
                                                    <a href="{{route('details')}}">fast furious</a>
                                                </h5>
                                                <div class="movie-time d-flex align-items-center my-2">
                        ...
                        <li class="swiper-slide">
                            <div class="iq-card card-hover">
                                <div class="block-images position-relative w-100">
                                    <div class="img-box w-100">
                                        <a href="{{route('details')}}" class="position-absolute top-0 bottom-0 start-0 end-0"></a>
                                        <img src="{{asset('assets')}}/main/img/movies/upcoming/06.html" alt="movie-card" class="img-fluid object-cover w-100 d-block border-0">
                                    </div>
                                    <div class="card-description with-transition">
                                        <div class="cart-content">
                                            <div class="content-left">
                                                <h5 class="iq-title text-capitalize">
                                                    <a href="{{route('details')}}">spiderman</a>
                                                </h5>
                                                <div class="movie-time d-flex align-items-center my-2">
                                                    <span class="movie-time-text font-normal">1hr : 45mins</span>
                                                </div>
                        ...
                        <li class="swiper-slide">
                            <div class="iq-card card-hover">
                                <div class="block-images position-relative w-100">
                                    <div class="img-box w-100">
                                        <a href="{{route('details')}}" class="position-absolute top-0 bottom-0 start-0 end-0"></a>
                                        <img src="{{asset('assets')}}/main/img/movies/upcoming/07.html" alt="movie-card" class="img-fluid object-cover w-100 d-block border-0">
                                    </div>
                                    <div class="card-description with-transition">
                                        <div class="cart-content">
                                            <div class="content-left">
                                                <h5 class="iq-title text-capitalize">
                                                    <a href="{{route('details')}}">onepeoc</a>
                                                </h5>
                                                <div class="movie-time d-flex align-items-center my-2">
