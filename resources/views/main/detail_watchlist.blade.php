        ...
        <div class="row">
            <div class="col-lg-4 col-md-5">
                <div class="playlist-main-banner position-relative">
                    ...
                    <div class="img-box">
                        <img src="{{asset('assets')}}/main/img/movies/ott2.html" alt="movie-card" class="img-fluid object-cover d-block">
                    </div>
                    <div class="img-detail z-3">
                        <a data-fslightbox="html5-video" href="{{asset('assets')}}/main/img/video/trailer.mp4" class="video-open playbtn text-decoration-none"
                            tabindex="0">
                        ...
                        <li>
                            <div class="watchlist-warpper card-style-two">
                                <div class="block-images d-flex align-items-center flex-wrap gap-2 gap-md-3">
                                    <div class="img-box">
                                        <a href="video-detail.html" class="position-absolute top-0 bottom-0 start-0 end-0"></a>
                                        <img src="{{asset('assets')}}/main/img/movies/latest/01.html" alt="movie-card" class="img-fluid object-cover d-block border-0">
                                    </div>
                        ...
                        <li>
                            <div class="watchlist-warpper card-style-two">
                                <div class="block-images d-flex align-items-center flex-wrap gap-2 gap-md-3">
                                    <div class="img-box">
                                        <a href="video-detail.html" class="position-absolute top-0 bottom-0 start-0 end-0"></a>
                                        <img src="{{asset('assets')}}/main/img/movies/latest/02.html" alt="movie-card" class="img-fluid object-cover d-block border-0">
                                    </div>
                                    <div class="card-description">
                        ...
                        <li>
                            <div class="watchlist-warpper card-style-two">
                                <div class="block-images d-flex align-items-center flex-wrap gap-2 gap-md-3">
                                    <div class="img-box">
                                        <a href="video-detail.html" class="position-absolute top-0 bottom-0 start-0 end-0"></a>
                                        <img src="{{asset('assets')}}/main/img/movies/latest/03.html" alt="movie-card" class="img-fluid object-cover d-block border-0">
                                    </div>
                                    <div class="card-description">
                        ...
                        <li>
                            <div class="watchlist-warpper card-style-two">
                                <div class="block-images d-flex align-items-center flex-wrap gap-2 gap-md-3">
                                    <div class="img-box">
                                        <a href="video-detail.html" class="position-absolute top-0 bottom-0 start-0 end-0"></a>
                                        <img src="{{asset('assets')}}/main/img/movies/latest/04.html" alt="movie-card" class="img-fluid object-cover d-block border-0">
                                    </div>
                                    <div class="card-description">
