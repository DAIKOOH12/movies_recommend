    ...
    <div class="row">
      <div class="col-lg-3 col-md-5">
        <div class="cast-box position-relative">
          <img src="{{asset('assets')}}/main/img/cast/01.html" class="img-fluid object-cover w-100" alt="person"
            loading="lazy">
              ...
              <div class="description-content">
                <div class="table-responsive">
                  <table class="table">
                    <tbody>
                      <tr>
                        <td class="w-15"><img src="{{asset('assets')}}/main/img/movies/latest/01.html" alt="image-icon"
                      ...
                      <tr>
                        <td class="w-15"><img src="{{asset('assets')}}/main/img/movies/latest/02.html" alt="image-icon"
                            class="img-fluid person-img object-cover"></td>
                        <td class="w-20">
                          <div class="font-size-18 d-flex gap-4 text-white fw-500">
                            <span>2</span>
                      ...
                      <tr>
                        <td class="w-15"><img src="{{asset('assets')}}/main/img/movies/latest/03.html" alt="image-icon"
                            class="img-fluid person-img object-cover"></td>
                        <td class="w-20">
                          <div class="font-size-18 d-flex gap-4 text-white fw-500">
                            <span>3</span>
                      ...
                      <tr>
                        <td class="w-15"><img src="{{asset('assets')}}/main/img/movies/latest/04.html" alt="image-icon"
                            class="img-fluid person-img object-cover"></td>
                        <td class="w-20">
                          <div class="font-size-18 d-flex gap-4 text-white fw-500">
                            <span>4</span>
